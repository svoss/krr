...
connected(loc1x2,loc1x3,n).
connected(loc1x2,loc2x2,e).
connected(loc1x1,loc1x2,n). 
connected(loc1x2,loc1x1,s).
connected(loc1x3,loc1x4,n).
connected(loc1x3,loc2x3,e).
connected(loc1x3,loc1x2,s).
connected(loc1x4,loc2x4,e).
connected(loc1x4,loc1x3,s).
connected(loc2x1,loc1x1,w).
connected(loc2x1,loc2x2,n).
connected(loc2x1,loc3x1,e).
connected(loc2x2,loc2x3,n).
connected(loc2x2,loc3x2,e).
connected(loc2x2,loc2x1,s).
connected(loc2x2,loc1x2,w).
connected(loc2x3,loc2x4,n).
connected(loc2x3,loc3x3,e).
connected(loc2x3,loc2x2,s).
connected(loc2x3,loc1x3,w).
connected(loc2x4,loc2x4,w).
connected(loc3x4,loc2x3,s).
connected(loc3x4,loc1x4,w).
connected(loc3x1,loc3x2,n).
connected(loc3x1,loc2x1,w).
connected(loc3x2,loc3x3,n).
connected(loc3x2,loc3x1,s).
connected(loc3x2,loc2x2,w).
connected(loc3x3,loc3x2,s).
